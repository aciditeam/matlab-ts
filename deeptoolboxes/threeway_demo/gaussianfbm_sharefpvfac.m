...
% Feature-factor, past-factor and visible-factor  weights are shared
%
...
%%%%%%%%% START POSITIVE PHASE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    poshidprobs = 1./(1 + exp(-yvisfeat*hidfac'  ...
      -ypastfeat*hidfacB' - repmat(hidbiases,numcases,1)));
    ...
    pospastBprod = past'*(yfeat.*yhidB_); %smoothed
...
%       (ypasthidB_)*featfac'; 
   ...
   posfeatgrad = (yvishid_ + yvispast + ypasthidB_)*featfac';
...
%%%%%%%%% START NEGATIVE PHASE  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
  ...
  for cdn = 1:cdsteps    
    ...
    if cdn == cdsteps     
      ...
      negpastBprod = past'*(yfeat.*yhidB_); %smoothed
...
%         (ypasthidB_)*featfac';
      ...
      negfeatgrad = (yvishid_ + yvispast + ypasthidB_)*featfac';
...
%%%%%%%%%%%%%%%% END OF UPDATES  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  if mod(epoch,1) ==0
      ...
      %pass 3-way term + gated biases + hidbiases through sigmoid
      poshidprobs = 1./(1 + exp(-yvisfeat*hidfac'  ...
        -ypastfeat*hidfacB' - repmat(hidbiases,nc,1)));
